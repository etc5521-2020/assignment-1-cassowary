...
Using the dataset for the word clouds, a deep analysis was conducted in the articles to look into the articles, if they regulated any types of tax or taxes on data. Upon exploration of the dataset, it was found that no tax regulations are in place under the articles from the dataset. Therefore, it can be said that there are only fines listed in the General Data Protection Regulations. 
