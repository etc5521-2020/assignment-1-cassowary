...
\@ref (fig:plot2) shows the number of GDPR violations that got fined from 2018 to 2020. Time periods when high number of GDPR fines were recorded are painted in red.   
The last quarter of 2019 and the first quarter of 2020 saw the highest number of GDPR violations. 
```{r plot2}
