...
### Characteristics of GDPR violations across countries (How commited are countries; in enforcing GDPR)
...
countries_map <- left_join(countries_map, countries_sf,
          by = c("name"))
...
gdpr_vio %>%
  ...
  ggplot() +
  geom_boxplot(aes(price, fct_reorder(name, md, .desc = F))) +
  scale_x_log10() +
  ylab("Country") + 
