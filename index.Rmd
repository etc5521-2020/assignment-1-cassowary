...
The data is scraped from @Privacy-Affairs by @Ellis-Hughes, posted on @Tidy-Tuesday. We adapted the scripts they used and removed duplication of GDPR fines due to multiple sources. Data spans from 2018-05-12 to 2020-08-21. 
...
With the regulation still in its novelty stage, it would be interesting to see where it goes from here.
